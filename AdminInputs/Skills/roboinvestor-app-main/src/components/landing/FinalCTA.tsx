    ...
    <section className="relative overflow-hidden bg-black py-24">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <h2 className="font-heading mb-6 text-4xl font-bold text-white md:text-5xl">
          Ready to Build Your Investment Intelligence?
        </h2>
        <p className="mb-12 text-xl text-gray-300">
          Start building AI-powered investment applications with the
        ...
        <div className="flex justify-center">
          <a
            ...
            className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 px-8 py-4 text-lg font-medium text-white shadow-2xl shadow-emerald-500/25 transition-all duration-300 hover:shadow-emerald-500/40"
          >
